  ...
  return (
    <main className="twin-shell">
      ...
      <header className="command-header twin-header">
        ...
        <nav className="product-nav" aria-label="Product modules"><Link href="/">Live Maritime Watch</Link><Link className="active" href="/digital-twin">Digital Twin</Link><Link href="/scenario-lab">Scenario Lab</Link></nav>
      </header>
