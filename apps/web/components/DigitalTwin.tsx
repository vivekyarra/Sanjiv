  ...
  return (
    <main className="twin-shell">
      ...
      <header className="command-header twin-header">
        ...
        <nav className="product-nav" aria-label="Product modules"><Link href="/">Live Maritime Watch</Link><Link className="active" href="/digital-twin">Digital Twin</Link><Link href="/scenario-lab">Scenario Lab</Link><Link href="/response-planner">Response Planner</Link><Link href="/strategic-reserve">Strategic Reserve</Link><Link href="/risk-intelligence">Risk Intelligence</Link><Link href="/evidence-approval">Evidence &amp; Approval</Link></nav>
      </header>
