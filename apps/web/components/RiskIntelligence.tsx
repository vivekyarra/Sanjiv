...
export function RiskIntelligence() {
  ...
  return <main className="command-shell response-planner">
    ...
    <nav className="product-nav" aria-label="Product modules">
      <Link href="/">Live Maritime Watch</Link><Link href="/digital-twin">Digital Twin</Link><Link href="/scenario-lab">Scenario Lab</Link><Link href="/response-planner">Response Planner</Link><Link href="/strategic-reserve">Strategic Reserve</Link><Link className="active" href="/risk-intelligence">Risk Intelligence</Link>
    </nav>
